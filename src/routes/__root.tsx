...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "IntelliGlass AI" },
      { name: "description", content: "IntelliGlass AI is a voice-controlled mobile assistant for visually impaired users." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "IntelliGlass AI" },
      { property: "og:description", content: "IntelliGlass AI is a voice-controlled mobile assistant for visually impaired users." },
